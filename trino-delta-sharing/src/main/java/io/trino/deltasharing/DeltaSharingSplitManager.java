        ...
        implements ConnectorSplitManager
{
    ...
    private final DeltaSharingClientV1 deltaSharingClientV1;
            ...
            Constraint constraint)
    {
        ...
        deltaFiles.stream().forEach(deltaFile -> deltaSharingSplitBuilder.add(new DeltaSharingSplit((DeltaSharingTableHandle) table, addresses, deltaFile)));
