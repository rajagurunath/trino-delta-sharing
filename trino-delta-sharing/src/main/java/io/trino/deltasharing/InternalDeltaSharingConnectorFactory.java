            ...
            Module module)
    {
        ...
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            Bootstrap app = new Bootstrap(
                    new EventModule(),
                    new MBeanModule(),
                    new ConnectorObjectNameGeneratorModule("io.trino.plugin.deltasharing", "trino.plugin.deltasharing"),
                    new JsonModule(),
...
//            ConnectorPageSourceProvider connectorPageSource = (ConnectorPageSourceProvider)injector.getInstance(ConnectorPageSourceProvider.class);
            ...
            HdfsFileSystemFactory hdfsFileSystemFactory = new HdfsFileSystemFactory(hdfsEnvironment);
            DeltaSharingPageSourceProvider deltaSharingPageSourceProvider = new DeltaSharingPageSourceProvider(hdfsFileSystemFactory, new FileFormatDataSourceStats(), new ParquetReaderConfig());
