 ...
 */
package io.trino.deltasharing.reader;
...
import static io.trino.plugin.hive.HiveSessionProperties.*;
            ...
            int domainCompactionThreshold)
    {
        ...
        try {
            ...
            ParquetReaderProvider parquetReaderProvider = fields -> new ParquetReader(
                    ...
                    options,
                    exception -> ParquetPageSource.handleException(dataSourceId, exception),
