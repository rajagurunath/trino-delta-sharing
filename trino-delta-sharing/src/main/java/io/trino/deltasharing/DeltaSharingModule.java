...
import io.trino.deltasharing.reader.ParquetPageSource;
...
import io.trino.deltasharing.reader.ParquetReaderConfig;
...
//        binder.bind(HdfsFileSystemFactory.class).in(Scopes.SINGLETON);
        binder.bind(DeltaSharingConnector.class).in(Scopes.SINGLETON);
//        binder.bind(TrinoFileSystem.class).in(Scopes.SINGLETON);
